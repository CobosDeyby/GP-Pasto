...
<head>
    ...
    <script>//<![CDATA[
        ...
        gtag('config', 'G-BHLQ28VZVZ');
      //]]></script>
</head>

<body>
    <div class="container-fluid navbar_inicio">
        <div class="row">
            <div class="col-8 col-md-10 d-flex justify-content-between align-items-center">
                <div class="">
                    <img src="./img/public/logofinal_gov.png" alt="" />
                </div>
            </div>
            <div class="col-1 text-center navbar_img-bandera">
                <img src="./img/public/banderaColombia.png" alt="" class="" />
            </div>
        </div>
    </div>
            ...
            <div class="container-fluid d-flex align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav text-center navbar_img-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link border-end border-dark" href="#cronograma">
                                <img src="./img/svg/datos.svg" alt="icono datos" />
                                <p class="m-1">Cronogrma</p>
                            </a>
                        </li>
    ...
    <!-- Bandera de Colombia -->
    <section>
        <div class="masthead mt-2"></div>
    </section>

    <!-- Dias de gobierno -->
    <div class="container-fluid d-flex bg-light justify-content-center p-2">
        <div class="d-flex justify-content-center align-items-center">
            <div class="">
                <h6 class="pe-2 titulo_gobierno">¡El Gobierno del cambio!</h6>
            </div>
            <div class="d-flex border-end border-start border-2 px-2">
                <h6 class="numero_dias"></h6>
            </div>
            <div class="text-primary ps-2">
                <h6 class="dias_gobierno"><span>DÍAS</span></h6>
            </div>
        </div>
    </div>
    <!-- Section: banner encuentro de medios -->
    <section>
    ...
    <section id="transmision">
        <div class="container col-12 col-sm-12 my-3">
            <div class="ratio ratio-16x9">
<iframe width="560" height="315" src="https://www.youtube.com/embed/y4NhhWyzTaE" title="Ministerio de Cultura" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
    </section>-->
    <hr>
<section class="container py-5">
  ...
  <div class="table-responsive">
    ...
    <!-- Section: footer-->
    <section>
        <div class="col-12 linea_footer-botton">
          <p class="volver"><a href="https://petro.presidencia.gov.co/">Volver al sitio web www.presidencia.gov.co</a></p>
        </div>
    </section>
